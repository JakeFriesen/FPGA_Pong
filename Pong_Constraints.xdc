...
# LEDs
#set_property PACKAGE_PIN U16 [get_ports {camera_configured}]					
...
set_property PACKAGE_PIN U2 [get_ports {LED_num[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_num[0]}]
set_property PACKAGE_PIN U4 [get_ports {LED_num[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_num[1]}]
set_property PACKAGE_PIN V4 [get_ports {LED_num[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_num[2]}]
set_property PACKAGE_PIN W4 [get_ports {LED_num[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LED_num[3]}]
...
#Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {clk_out_25MHz}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {clk_out_25MHz}]
#Sch name = XA3_N
